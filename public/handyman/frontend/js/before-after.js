    ...
    return this.each(function () {
      !(function (t) {
        if (2 == jQuery(t).children().length) {
          ...
          w.setAttribute(
            "style",
            "position:absolute;width:90px;height:90px;line-height:80px;padding:4xp;text-align:center;top:50%;left:50%;transform:translate(-50%,-50%);border-radius:50%;background-color:#000000;border:5px solid #fff"
          );
          ...
          x.setAttribute(
            "style",
            "position:absolute !important;width:5px !important;height:100% !important;top:0px !important;right:" +
              o.position +
